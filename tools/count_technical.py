...
TECHNICAL_CATEGORIES = {'infosec', 'foss', 'coding', 'ai', 'technology', 'dev', 'programming'}
...
for filename in files:
    ...
    cats = frontmatter_categories(content)
    if any(cat.lower() in TECHNICAL_CATEGORIES for cat in cats):
        technical += 1
    else:
        non_technical += 1

print(f'Technical: {technical}')
print(f'Non-technical: {non_technical}')
